...
public class FileBackedDictionary implements DictionaryDatabase {
	...
	/** Construct a DictionaryDatabase that retrieves file data from <code>fileManager</code>.

	 * A client can use this to create a DictionaryDatabase backed by a RemoteFileManager.
